...
public class Utilities {
    ...
    private static String filePath1 = "../../../Conferinte/GECCO_2015/multiobjective ACO/MoACO_D-ACS (2 matrici cu informatie euristica)/ParetoFront_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_amplitude_2200 iter (MoACO_D-ACS)_2 heuristic" + ".xlsx";
    private static String filePath2 = "../../../Conferinte/GECCO_2015/fisiere intermediare/Rulari MoACO_D-ACS_2 heuristic_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_total, subtour costs and amplitude.txt";
    ...
    static void writeParetoSet(ArrayList<Solution> bestSoFarPareto, int trial) {
    	Row r;
    	Cell c;
    	int lineNumber = 0;
    ...
    static void writeParetoSolutions(ArrayList<Solution> bestSoFarPareto) {
