...
public class ParetoFront {
	...
	static ArrayList<Solution> bestSoFarPareto = new ArrayList<Solution>();
	...
	static ArrayList<Solution> iterationPareto = new ArrayList<Solution>();
	...
	public static byte solutionDominates(Solution solution1, Solution solution2) {
		boolean first = true;
		int l = 0;
		int nObjectives = TSP_ACO.k;
	...
	public static void paretoUpdateWithSolution(ArrayList<Solution> iterPareto, Solution a) {
		int i = 0;
	...
	public static void paretoUpdate(ArrayList<Solution> bestSoFarPareto, ArrayList<Solution> iterPareto) {
		int i,j;
		boolean dominated;
	...
	public static ArrayList<Solution> getBestSoFarPareto() {
		return bestSoFarPareto;
	}

	public static void setBestSoFarPareto(ArrayList<Solution> bestSoFarPareto) {
		ParetoFront.bestSoFarPareto = bestSoFarPareto;
	}

	public static ArrayList<Solution> getIterationPareto() {
		return iterationPareto;
	}

	public static void setIterationPareto(ArrayList<Solution> iterationPareto) {
		ParetoFront.iterationPareto = iterationPareto;
	}
	
	static class Solution {
		//id of the originating ant that gives this solution
    	int antId;
