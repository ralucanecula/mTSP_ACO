...
public class TSP_ACO {
	...
	private static String fileName = "eil51.tsp";
	//private static String fileName = "mtsp8.txt";
	...
	public static void main(String[] args) {
		...
		for (int trial = 0; trial < 1; trial++) {
		    ...
		    while (!termination_condition()) {
				...
				//search_control_and_statistics(iterTotalCost, iterLongestCost, saveIterCosts);
		...
		/*if (!saveIterCosts) {
			//Utilities.writeParetoSet(ParetoFront.bestSoFarPareto);
		}*/
