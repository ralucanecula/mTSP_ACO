...
public class Utilities {
    ...
    private static String filePath1 = "../../../Jurnale/jurnal Swarm Intelligence (Springer)/Experimente/Fronturi Pareto algoritmi (pe parcurs)/ACO MinMax_voiajor random/ParetoFront_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_amplitude_2200 iter (ACO MinMax_voiajor random)" + ".xlsx";
    private static String filePath2 = "../../../Jurnale/jurnal Swarm Intelligence (Springer)/Experimente/fisiere intermediare/Rulari ACO MinMax_voiajor random_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_total, subtour costs and amplitude.txt";
    ...
    //for verbose output: save at each 5 iteration the cost of the longest tour
...
*/	            //XSSFSheet sheet6 = workbook1.getSheetAt(startIndex + 5);  //for verbose output of longest cost at each 5 iteration
	            ...
	            //if (!saveIterCosts) {
	            	...
	            	if (trialNumber == 0) {
			            ...
			            c.setCellValue("Obtained solutions (values) after running vers. I (ACO MinMax global, voiajor ales random)");
