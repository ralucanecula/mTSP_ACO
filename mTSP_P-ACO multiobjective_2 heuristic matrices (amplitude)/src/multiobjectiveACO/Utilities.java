...
public class Utilities {
    ...
    private static String filePath1 = "../../../Conferinte/GECCO_2015/multiobjective ACO/P-ACO (2 matrici cu informatie euristica)/ParetoFront_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_amplitude_2200 iter (P-ACO)_2 heuristic" + ".xlsx";
    private static String filePath2 = "../../../Conferinte/GECCO_2015/fisiere intermediare/Rulari P-ACO_2 heuristic_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_total, subtour costs and amplitude.txt";
